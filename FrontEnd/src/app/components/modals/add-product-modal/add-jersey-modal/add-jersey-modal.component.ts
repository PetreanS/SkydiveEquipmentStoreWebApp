...
@Component({
  selector: 'app-add-jersey-modal',
  templateUrl: './add-jersey-modal.component.html',
  styleUrls: ['./add-jersey-modal.component.css']
})
export class AddJerseyModalComponent {
  ...
  productCategory: string = 'jersey';

  constructor(
    private dialogRef: MatDialogRef<AddJerseyModalComponent>,
